...
class Selector:
    ...
    def make_confusion_matrix(self, right_list: list, wrong_list: list, reask_list: list, legacy_ivr_list: list):
        ...
        y_true = [ x[1] for x in right_list ] + [ x[1] for x in wrong_list ]
        y_pred = [ ast.literal_eval(x[2])[0][0].split('_')[1] for x in right_list ] +[ ast.literal_eval(x[2])[0][0].split('_')[1] for x in wrong_list ]
